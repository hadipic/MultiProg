...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Strings_t, stringdata) + ofs \
...
const QMetaObject Strings::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Strings.data,
      qt_meta_data_Strings,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Strings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Strings.stringdata))
