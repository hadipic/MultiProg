...
public:
    ...
    void setupUi(QWidget *PicFuseSettings)
    {
        if (PicFuseSettings->objectName().isEmpty())
            PicFuseSettings->setObjectName(QString::fromUtf8("PicFuseSettings"));
        ...
        lblByte->setObjectName(QString::fromUtf8("lblByte"));
        ...
        lstConfigs->setObjectName(QString::fromUtf8("lstConfigs"));
        ...
        txtMemID->setObjectName(QString::fromUtf8("txtMemID"));
    ...
    {
        PicFuseSettings->setWindowTitle(QCoreApplication::translate("PicFuseSettings", "Form", nullptr));
        label_2->setText(QCoreApplication::translate("PicFuseSettings", "Settings:", nullptr));
        groupBox->setTitle(QString());
        lblByte->setText(QCoreApplication::translate("PicFuseSettings", "0 0 1 0 1 0 1 0", nullptr));
        label_3->setText(QCoreApplication::translate("PicFuseSettings", "ID:", nullptr));
        label->setText(QCoreApplication::translate("PicFuseSettings", "Configurations Words:", nullptr));
